        ...
        <div class="panel-body">
            <div class=" form">
                @foreach($errors->all() as $error)
                    <li>{{$error}}</li>
                @endforeach
                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{url('admin/users')}}" novalidate="novalidate" enctype="multipart/form-data">
                    <div class="form-group ">
                        <label for="cname" class="control-label col-lg-2">UserName (required)</label>
                        <div class="col-lg-10">
                            <input class="form-control valid" id="cname" name="username" value="{{ old('username') }}" minlength="2" required="" type="text">
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="cname" class="control-label col-lg-2">name (required)</label>
                        <div class="col-lg-10">
                            <input class="form-control valid" id="cname" name="name" value="{{ old('name') }}" minlength="2" required="" type="text">
                        </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control  error" id="cemail" name="email" value="{{ old('email') }}" required="" type="email"><label for="cemail" class="error">Please enter a valid email address.</label>
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="curl" class="control-label col-lg-2">password (required)</label>
                        <div class="col-lg-10">
                            <input class="form-control " id="curl" name="password" value="{{ old('password') }}" type="password">
                        </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control " id="ccomment" name="about" required="">{{ old('about') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group ">
